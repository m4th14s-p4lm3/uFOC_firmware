...
\begin{document}
	\begin{frontmatter}
		...
		\SgAddDeclaration%
		\input{doc_parts/acknowledgments}%
		\input{doc_parts/abstract}%
		...
		\input{doc_parts/nomenclature}	
		\printnomenclature
	\end{frontmatter}
	
	% Divide document into several parts
	\input{doc_parts/introduction}
	\input{doc_parts/foc_introduction.tex}
	\input{doc_parts/firmware_implementation}
	\input{doc_parts/testing}
	\input{doc_parts/future}

	\input{doc_parts/conclusion}
	
	% Appedices
	% \begin{appendices}
	% 	\input{doc_parts/appendixes}
	% \end{appendices}
	...
	\doloiAutoBib{biblio_files/biblio_basic}
