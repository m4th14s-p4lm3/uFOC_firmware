...
When operating above the rated motor speed, the controller was still able to accelerate the motor further, 
but noticeable oscillations appeared in the measured velocity signal.
These oscillations are likely caused by limitations of the motor mechanical design 
and increased back-EMF at higher rotational speeds rather than instability of the control loop itself.
