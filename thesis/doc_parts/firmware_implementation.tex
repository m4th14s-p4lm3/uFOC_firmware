...
and can be more easily adapted to different motor drivers if required. \cite{TI_DRV8316C}
...
\subsection{CAN communication in general}
...
An example python client was implemented in \texttt{pytools/ufoc\_client.py} using pycan library.
This python module implemnets a \texttt{uFOCclient} class... jada jada  

The \texttt{ufoc\_client.py} was used mainly for testing purposes.
